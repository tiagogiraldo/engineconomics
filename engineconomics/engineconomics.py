...
class time_value_table(object):
    ...
    def cfdataframe(self, cf_dic:dict):
        ...
        if (self.cf_dic['Factor'] == 'P/F') or (self.cf_dic['Factor'] == 'F/P'):
            ...
            return pd.DataFrame(list(zip(x_data, y_i_data, y_o_data)), columns=["Period", "Income", "Outcome"])
        ...
        if (self.cf_dic['Factor'] == 'P/G'):
            ...
            y_o_data = [0.] * (n+1)
            y_o_data[0] = pv 
            return pd.DataFrame(list(zip(x_data, y_ag_data, y_o_data)), columns=["Period", "Gradient Income", "Outcome"])            
        ...
        if (self.cf_dic['Factor'] == 'F/G'):
            ...
            y_o_data = [0.] * (n+1)
            y_o_data[-1] = fv 
            return pd.DataFrame(list(zip(x_data, y_ag_data, y_o_data)), columns=["Period", "Gradient Outcome", "Income"])            
        ...
        if (self.cf_dic['Factor'] == 'P/g'):
            ...
            y_o_data = [0.] * (n+1)
            y_o_data[0] = pv 
            return pd.DataFrame(list(zip(x_data, y_i_data, y_o_data)), columns=["Period", "Gradient Income", "Outcome"])            
    ...
    def npvtable(self, period_list:list, cf_list:list, i:float):
        ...
        return pd.DataFrame(ncfl, columns=['Period', 'Outcome', 'Income', 'ncf', 'dcf'])
    ...
    def npvsensitivitytable(self, period_list:list, cf_list:list, i_list:list):
        ...
        return  pd.DataFrame(table, columns=['npv', 'i'])
    ...
    def npvivtable(self, period_list:list, cf_list:list, iv:list):
        ...
        df = pd.DataFrame(ncf, columns=["Period", 'Outcome','Income',"ncf", "i_comp", "ie", "dcf"])
        return df
    ...
    def uniform_loan_amortization(self, loan_amount:float, rate:float, loan_term:int, periodicity:str='Y'):
        ...
        amortization_table = pd.DataFrame(data=data, columns=columns)
...
class time_value_plot(object):
    ...
    def cf_plot_bar(self, cf_dic:dict):
        ...
        if (self.cf_dic['Factor'] == 'P/F') or (self.cf_dic['Factor'] == 'F/P'):
            ...
            y_o_data = [pv] + [0] * (n)
            y_i_data = [0.] * (n) + [fv]
            df = pd.DataFrame(list(zip(x_data, y_i_data, y_o_data)), columns=["Period", "Income", "Outcome"])
            print(df)
        ...
        if (self.cf_dic['Factor'] == 'P/G'):
            ...
            y_o_data = [0.] * (n+1)
            y_o_data[0] = pv 
            df = pd.DataFrame(list(zip(x_data, y_ag_data, y_o_data)), columns=["Period", "Gradient Income", "Outcome"])            
            print(df)
        ...
        if (self.cf_dic['Factor'] == 'F/G'):
            ...
            y_o_data = [0.] * (n+1)
            y_o_data[-1] = fv 
            df = pd.DataFrame(list(zip(x_data, y_ag_data, y_o_data)), columns=["Period", "Gradient Outcome", "Income"])            
            print(df)
        ...
        if (self.cf_dic['Factor'] == 'P/g'):
            ...
            df = pd.DataFrame(list(zip(x_data, y_i_data, y_o_data)), columns=["Period", "Gradient Income", "Outcome"])            
            print(df)
...
class compound_interest(object):
    ...
    def irr(self,npw, period_list:list, cf_list:list):
        ...
        irr_ = optimize.root(f, [0], tol=0.00000001)['x'][0]
